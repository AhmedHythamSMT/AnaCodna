    ...
    <script>
        ...
        function displayContent(index) {
            var content = `
                ...
                <img src="data:image/jpeg;base64,${contentArray[index].photo1}" alt="Photo 1">
                <h2>${contentArray[index].header2}</h2>
                <p>${contentArray[index].paragraph2}</p>
                <img src="data:image/jpeg;base64,${contentArray[index].photo2}" alt="Photo 2">
                <h2>${contentArray[index].header3}</h2>
                <p>${contentArray[index].paragraph3}</p>
                <img src="data:image/jpeg;base64,${contentArray[index].photo3}" alt="Photo 3">
                <h2>${contentArray[index].header4}</h2>
                <p>${contentArray[index].paragraph4}</p>
                <img src="data:image/jpeg;base64,${contentArray[index].photo4}" alt="Photo 4">4
